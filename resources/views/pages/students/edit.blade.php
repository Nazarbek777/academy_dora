            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">O'quvchini tahrirlash</li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                  <form action="{{ route('students.update', $student->id) }}" method="POST">
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label for="branch_id" class="fw-semibold">Fililani kiriitng: </label>
                                            </div>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label for="name" class="fw-semibold">Student ismini kiriting:</label>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="feather-user"></i></div>
                                                    <input type="text" class="form-control" id="name" placeholder="Student ismini kiriting" name="name" value="{{ $student->name }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label for="phone" class="fw-semibold">Telefon raqamini kiriting:</label>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="feather-phone"></i></div>
                                                    <input type="text" class="form-control" id="phone" placeholder="Telefon raqamini kiriting" name="phone" value="{{ $student->phone }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label for="address" class="fw-semibold">Manzilni kiriting:</label>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="feather-map-pin"></i></div>
                                                    <textarea class="form-control" id="address" cols="30" rows="3" placeholder="Manzilni kiriting" name="area">{{ $student->area }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label for="date" class="fw-semibold">O'quvchi kelgan sana kiriting:</label>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="feather-calendar"></i></div>
                                                    <input type="date" name="date" class="form-control" id="date" placeholder="Ochilgan sananini kiriting" value="{{ $student->date }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label for="directions" class="fw-semibold">Yo'nalishlarni kiriting:</label>
                                            </div>
                                            <div class="col-lg-8">
                                                <select name="directions[]" class="form-select form-control max-select" data-select2-selector="tag" multiple>
                                                    <option value="Frontend" data-bg="bg-success" {{ in_array('Frontend', $student->directions) ? 'selected' : '' }}>Frontend</option>
                                                    <option value="Backend" data-bg="bg-info" {{ in_array('Backend', $student->directions) ? 'selected' : '' }}>Backend</option>
                                                    <option value="Smm" data-bg="bg-primary" {{ in_array('Smm', $student->directions) ? 'selected' : '' }}>Smm</option>
                                                    <option value="Marketing" data-bg="bg-teal" {{ in_array('Marketing', $student->directions) ? 'selected' : '' }}>Marketing</option>
                                                    <option value="Design" data-bg="bg-success" {{ in_array('Design', $student->directions) ? 'selected' : '' }}>Design</option>
                                                </select>
                                            </div>
                                        </div>
