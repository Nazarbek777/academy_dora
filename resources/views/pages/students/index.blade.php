                                    ...
                                    <table class="table table-hover" id="customerList">
                                        ...
                                        @foreach ($students as $branch)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('students.show', $branch->id) }}"
                                                       class="hstack gap-3">
                                                        <div>
                                                            <span
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <a href="{{ route('students.edit', $branch->id) }}"
                                                           class="avatar-text avatar-md">
                                                        ...
                                                        <form id="deleteForm" action="{{ route('students.destroy', $branch->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                        @csrf
                                                        @method('DELETE')
