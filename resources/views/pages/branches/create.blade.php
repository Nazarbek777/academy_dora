                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea class="form-control" id="addressInput_2" cols="30" rows="3" placeholder="Manzilni kiriting" name="area"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mb-4 align-items-center">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select name="directions[]" class="form-select form-control max-select" data-select2-selector="tag" multiple>
                                                            <option value="Frontend" data-bg="bg-success">Frontend</option>
                                                            <option value="Backend" data-bg="bg-info">Backend</option>
                                                            <option value="Smm" data-bg="bg-primary">Smm</option>
                                                            <option value="Marketing" data-bg="bg-teal">Marketing</option>
