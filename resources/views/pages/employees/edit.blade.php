            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Xodimni tahrirlash</li>
                    </ul>
                </div>
                    ...
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <a href="javascript:void(0);" class="btn btn-light-brand successAlertMessage">
                                ...
                                <span>Shartnoma yuklab olish</span>
                            </a>
                            ...
                            <form action="{{ route('employees.update', $employee->id) }}" method="POST">
                                ...
                                <div class="card-body personal-info">
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                            <label for="companyInput" class="fw-semibold">Filialni tanlang: </label>
                                        </div>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="fullnameInput" placeholder="Ismingizni kiriting" name="name" value="{{ $employee->name }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="mailInput" placeholder="Pasport raqam va seriani kiriting" name="pass" value="{{ $employee->pass }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                            <label for="dateofBirth" class="fw-semibold">Ochilgan sanani kiriting:</label>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-calendar"></i></div>
                                                <input type="date" name="date" class="form-control" id="dateofBirth" placeholder="Ochilgan sanani kiriting" value="{{ $employee->date }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="directions[]" class="form-select form-control max-select" data-select2-selector="tag" multiple>
                                                <option value="Frontend" {{ in_array('Frontend', $employee->directions) ? 'selected' : '' }} data-bg="bg-success">Frontend</option>
                                                <option value="Backend" {{ in_array('Backend', $employee->directions) ? 'selected' : '' }} data-bg="bg-info">Backend</option>
                                                <option value="Smm" {{ in_array('Smm', $employee->directions) ? 'selected' : '' }} data-bg="bg-info">Smm</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="status" class="form-control" data-select2-selector="status">
                                                <option value="Active" {{ $employee->status == 'Active' ? 'selected' : '' }} data-bg="bg-success">Active</option>
                                                <option value="Inactive" {{ $employee->status == 'Inactive' ? 'selected' : '' }} data-bg="bg-warning">Inactive</option>
                                                <option value="Declined" {{ $employee->status == 'Declined' ? 'selected' : '' }} data-bg="bg-danger">Declined</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="phoneInput" placeholder="Telefon raqamingizni kiriting" name="phone" value="{{ $employee->phone }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
