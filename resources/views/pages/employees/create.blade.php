            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Yangi xodim qo'shish</li>
                    </ul>
                </div>
                    ...
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <a href="javascript:void(0);" class="btn btn-primary successAlertMessage">
                                ...
                                <span>Yangi xodimni saqlash</span>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <form action="{{ route('employees.store') }}" method="POST">
                                      <div class="row">
                                        ...
                                        <div class="card-body personal-info">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="fullnameInput" class="fw-semibold">Ismingizni kiriting: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="mailInput" class="fw-semibold">Pasport raqam va seriani kiriting: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather-mail"></i></div>
                                                        <input type="text" class="form-control" id="mailInput"
                                                               placeholder="Pasport raqam va seriani kiriting" name="pass">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="dateofBirth" class="fw-semibold">Ochilgan sananini kiriting:</label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <div class="input-group-text"><i class="feather-calendar"></i></div>
                                                        <input type="date" name="date" class="form-control" id="dateofBirth" placeholder="Ochilgan sananini kiriting">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="Input" class="fw-semibold">Mutaxasisligini kiriting: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="col-lg-8">
                                                        <select name="directions[]" class="form-select form-control max-select" data-select2-selector="tag" multiple>
                                                            <option value="Frontentd" data-bg="bg-success">Frontentd</option>
                                                            <option value="Backend" data-bg="bg-info">Backend</option>
                                                            <option value="Smm" data-bg="bg-info">Smm</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                <div class="col-lg-4">
                                                    <label for="phoneInput" class="fw-semibold">Telefon raqamingizni kiriting: </label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="phoneInput"
                                                               placeholder="Telefon raqamingizni kiriting" name="phone">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" data-select2-selector="country">
                                                        ...
                                                        <option data-country="fk">Falkland Islands (Islas Malvinas)
                                                        </option>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" data-select2-selector="tzone">
                                                        ...
                                                        <option data-tzone="feather-moon">(GMT -11:00) Midway Island,
                                                            Samoa
                                                        </option>
                                                        ...
                                                        <option data-tzone="feather-sun">(GMT +2:00) Kaliningrad, South
                                                            Africa
                                                        </option>
                                                        <option data-tzone="feather-sun">(GMT +3:00) Baghdad, Riyadh,
                                                            Moscow, St. Petersburg
                                                        </option>
                                                        <option data-tzone="feather-sun">(GMT +3:30) Tehran</option>
                                                        <option data-tzone="feather-sun">(GMT +4:00) Abu Dhabi, Muscat,
                                                            Baku, Tbilisi
                                                        </option>
                                                        ...
                                                        <option data-tzone="feather-sun">(GMT +5:30) Bombay, Calcutta,
                                                            Madras, New Delhi
                                                        </option>
                                                        ...
                                                        <option data-tzone="feather-sun">(GMT +6:30) Yangon, Mandalay
                                                        </option>
                                                        ...
                                                        <option data-tzone="feather-sun">(GMT +9:30) Adelaide, Darwin
                                                        </option>
                                                        <option data-tzone="feather-sun">(GMT +10:00) Eastern Australia,
                                                            Guam, Vladivostok
                                                        </option>
                                                        <option data-tzone="feather-sun">(GMT +10:30) Lord Howe Island
                                                        </option>
                                                        <option data-tzone="feather-sun">(GMT +11:00) Magadan, Solomon
                                                        ...
                                                        <option data-tzone="feather-sun">(GMT +12:45) Chatham Islands
                                                        </option>
                                                        <option data-tzone="feather-sun">(GMT +13:00) Apia, Nukualofa
                                                        </option>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" data-select2-selector="language"
                                                        ...
                                                        <option data-language="bg-cyan">Azerbaijani - azərbaycan dili
                                                        </option>
                                                        ...
                                                        <option data-language="bg-cyan">Chinese (Hong Kong) -
                                                            中文（香港）
                                                        </option>
                                                        ...
                                                        <option data-language="bg-success">French (Canada) - français
                                                            (Canada)
                                                        </option>
                                                        <option data-language="bg-warning">French (France) - français
                                                            (France)
                                                        </option>
                                            ...
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" data-select2-selector="currency">
                                                        ...
                                                        <option data-currency="ba">BAM - Bosnia-Herzegovina Convertible
                                                            Mark - KM
                                                        </option>
                                                        ...
                                                        <option data-currency="cz">CZK - Czech Republic Koruna - Kč
                                                        </option>
                                                        ...
                                                        <option data-currency="gr">GRD - Greek Drachma - ₯, Δρχ, Δρ
                                                        </option>
                                                        ...
                                                        <option data-currency="nl">ANG - Netherlands Antillean Guilder -
                                                            ƒ
                                                        </option>
                                                        ...
                                                        <option data-currency="pg">PGK - Papua New Guinean Kina - K
                                                        </option>
                                                        ...
                                                        <option data-currency="sb">SBD - Solomon Islands Dollar - Si$
                                                        </option>
                                            ...
                                            <div class="row mb-0 align-items-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" data-select2-selector="privacy">
                                                        ...
                                                        <option value="followme" data-icon="feather-eye">People Follow
                                                            Me
                                                        </option>
                                                        <option value="customselectever" data-icon="feather-settings">
                                                            Custom Select Ever
                                                        </option>
                                                    </select>
                                                </div>
